...
export const Navbar = () => {
  ...
  const LightIcon = () => (
    <Tooltip title="Toogle Light Theme" placement="left" arrow TransitionComponent={Zoom}>
  ...
  const DarkIcon = () => (
    <Tooltip title="Toogle Dark Theme" placement="left" arrow TransitionComponent={Zoom}>
      <IconButton onClick={() => handleThemeChange()}>
